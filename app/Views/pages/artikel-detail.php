...
<section class="py-5">
    <div class="container">
        ...
        <p class="text-light" data-aos="fade-up" data-aos-delay="150">
            ...
            Ditulis oleh: 
            <?php if ($artikel['role'] == 'BPN'): ?>
                BPN
            <?php elseif ($artikel['role'] == 'BPW'): ?>
                <?= esc($artikel['provinsi_nama']) ?>
            <?php elseif ($artikel['role'] == 'BPD'): ?>
                <?= esc($artikel['kabupaten_nama']) ?>
            <?php elseif ($artikel['role'] == 'BPDes'): ?>
                <?= esc($artikel['desa_nama']) ?>
            <?php else: ?>
                -
            <?php endif; ?>
        </p>
