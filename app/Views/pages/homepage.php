                    ...
                    <div class="hero-slider swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="<?= base_url('assets/img/abstract/abstract-1.webp') ?>" alt="Slide 1">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?= base_url('assets/img/abstract/abstract-2.webp') ?>" alt="Slide 2">
                            </div>
                            <div class="swiper-slide">
                                <img src="<?= base_url('assets/img/abstract/abstract-3.webp') ?>" alt="Slide 3">
                            </div>
                        </div>
            ...
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="about-image position-relative">
                        <img src="assets/img/about/Logo GESID-01.jpg" class="img-fluid rounded-4 shadow-sm" alt="About Image" loading="lazy">
                    </div>
                </div>
                ...
                <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left" data-aos-delay="300">
                    <div class="about-content">
                        ...
                        <p>
                            <strong>Peran Desa dalam Pembangunan Berkelanjutan</strong> – Desa memiliki potensi sumber daya alam dan manusia yang besar untuk mendorong kemandirian dan kesejahteraan.
                        </p>
                        <p>
                            <strong>Bonus Demografi 2020–2045</strong> – Meningkatnya penduduk usia produktif, termasuk di desa, memerlukan pemberdayaan generasi muda agar potensi ini dapat dimanfaatkan maksimal.
                        </p>
                                ...
                                <a href="<?= base_url('latar-belakang') ?>" class="text-decoration-none">
                                    <div class="feature-item text-center p-4 shadow-sm rounded h-100">
                                        ...
                                        <p class="text-white-50">
                                            Pelajari latar belakang dan tujuan dari GESID dalam membangun generasi emas Indonesia.
                                        </p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="400">
                                <a href="<?= base_url('visi-misi') ?>" class="text-decoration-none">
                                    <div class="feature-item text-center p-4 shadow-sm rounded h-100">
                                        ...
                                        <p class="text-white-50">
                                            Kenali visi besar dan misi utama GESID dalam mendukung pembangunan sumber daya manusia.
                                        </p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="500">
                                <a href="<?= base_url('pengurus-bpn') ?>" class="text-decoration-none">
                                    <div class="feature-item text-center p-4 shadow-sm rounded h-100">
                                        ...
                                        <p class="text-white-50">
                                            Daftar pengurus Badan Pengurus Nasional (BPN) GESID dan struktur organisasinya.
                                        </p>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card border-0 shadow-lg h-100">
                        <img src="<?= base_url('assets/img/artikel/kategori-1.jpg') ?>" class="card-img-top" alt="Artikel Utama">
                        <div class="card-body">
                            <div class="d-flex align-items-center text-muted mb-2">
                                <i class="bi bi-calendar-event me-2"></i> 5 Agustus 2025
                                <span class="mx-2">•</span>
                                <span>Berita GESID</span>
                            </div>
                            <h5 class="card-title fw-bold">Kegiatan GESID 1</h5>
                            <p class="card-text">
                                Suasana asri dan kebersamaan warga dalam kegiatan gotong royong, festival, dan pasar rakyat.
                            </p>
                            <a href="<?= base_url('artikel/detail/1') ?>" class="btn text-white fw-bold rounded-pill px-4" style="background-color: #ffc107;">
                                Baca Selengkapnya..
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="list-group list-group-flush mb-3">
                        <?php for ($i = 2; $i <= 4; $i++): ?>
                            <a href="<?= base_url('artikel-detail/' . $i) ?>"
                                class="list-group-item list-group-item-action d-flex align-items-center"
                                data-aos="fade-up" data-aos-delay="<?= 200 + ($i * 100) ?>">
                                <img src="<?= base_url('assets/img/artikel/kategori-' . $i . '.jpg') ?>" alt="Thumb" class="rounded me-3" style="width: 70px; height: 70px; object-fit: cover;">
                                <div>
                                    <small class="text-muted d-block mb-1"><i class="bi bi-calendar-event me-1"></i>5 Agustus 2025</small>
                                    <span class="fw-semibold">Kegiatan GESID <?= $i ?></span>
                                </div>
                            </a>
                        <?php endfor; ?>
                    </div>
                    ...
                    <div class="text-end" data-aos="fade-up" data-aos-delay="500">
                        <a href="<?= base_url('artikel') ?>" class="btn btn-outline-warning rounded-pill px-4 fw-bold">Lihat Semua Artikel</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="service-header text-center">
                <div class="service-summary">
                    <p style="font-weight: 600;">
                        Dari panggung budaya, kegiatan sosial, hingga perayaan penuh warna — setiap event GESID dirancang
            ...
            <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="member-image position-relative">
                        <img src="assets/img/member/member.jpg" class="img-fluid rounded-4 shadow-sm" alt="Member Image" loading="lazy">
                    </div>
                </div>
                ...
                <div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left" data-aos-delay="300">
                    ...
                    <p class="lead">Ayo jadi bagian dari komunitas yang hangat dan penuh inspirasi. Bersama GESID, kita saling berbagi, belajar, dan tumbuh bersama.</p>
                    <p>Melalui kegiatan seru, pelatihan bermanfaat, dan peluang kolaborasi, Anda akan menemukan teman baru, wawasan baru, dan kesempatan untuk berkembang baik secara pribadi maupun profesional.</p>
                    ...
                    <div class="row g-4 mt-3">
                        ...
                        <div class="col-md-6" data-aos="zoom-in" data-aos-delay="300">
                            <div class="feature-item text-center p-4 shadow-sm rounded bg-dark text-white h-100">
                                ...
                                <a href="<?= base_url('cara-daftar') ?>" class="btn btn-outline-primary mt-3">Lihat Selengkapnya</a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" data-aos="zoom-in" data-aos-delay="400">
                            <div class="feature-item text-center p-4 shadow-sm rounded bg-dark text-white h-100">
                                ...
                                <a href="<?= base_url('formulir-pendaftaran') ?>" class="btn btn-outline-success mt-3">Lihat Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3 text-start">
                        <a href="<?= base_url('halaman-member') ?>" class="btn btn-warning text-white" style="font-size: 1rem; padding: 8px 28px; border-radius: 50px;">
                            Lihat Selengkapnya..
                        </a>
                    </div>
                </div>
